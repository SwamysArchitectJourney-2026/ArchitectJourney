...
learning_objectives:
  - "Review 30-day study plan for Staff Engineer track"
  - "Understand structured preparation approach"
  - "Prepare comprehensive interview preparation"
related_topics:
  prerequisites: ["./03_Principal-Consultant-Question-Bank-Part2-F-1.md"]
  builds_upon: []
  enables: ["./03_Principal-Consultant-Question-Bank-Part2-G.md"]
  cross_refs: []
---

# Principal Consultant Interview Prep - Study Plan (Part 2-F-2)

**30-day study plan** for Principal Consultant / Staff Engineer interviews.
...
- [Part 2-F-1: Cheat Sheets](./03_Principal-Consultant-Question-Bank-Part2-F-1.md) - Principal-level cheat sheets
