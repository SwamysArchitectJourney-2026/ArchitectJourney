...
**Role**: Technical Project Manager (with development background)  
...
### 2. Technical Round (Architecture + SDLC + Dev Background)

- System design
- API design & microservices
- DevOps fundamentals
- SDLC + Agile process deep dive
- Debugging real project situations
- Coding fundamentals (problem-solving focus)

### 3. Agile/Scrum Expertise Round

- Running a real sprint scenario
- What you do when things go wrong
- Managing dependencies, risks, conflicts
- JIRA workflows
- Planning & estimation

### 4. Leadership + Stakeholder Management Round
...
### 5. Behavioural / STAR Method Round

- Leadership challenges
- Managing senior developers
- Handling pressure projects

---

## 🎯 Your Preparation Strategy (7 Days Plan)

### Day 1–2: System Design + Architecture

- Prepare 3 architecture diagrams
- Review microservices patterns
- Practice API design

### Day 3: Agile & Scrum Mastery

- Simulate sprint planning, grooming, and retrospective
- Review Agile metrics and reporting

### Day 4: DevOps + CI/CD

- Revise pipelines, branching, deployment models
- Review observability and monitoring

### Day 5: Leadership + Stakeholder Management
...
- Full mock interview preparation
- Review all question banks
...
- **[System Design Model Answers](../02_Common/02_SystemDesign/01_System-Design-Model-Answers-Part1-A-1.md)** (Part 1-A-1) | [Part 1-A-2](../02_Common/02_SystemDesign/01_System-Design-Model-Answers-Part1-A-2.md) - Generic system design model answers (moved to Common)
...
As a **.NET Architect**, emphasize:

- ✅ Technical leadership
- ✅ Architecture knowledge
- ✅ Agile delivery experience
- ✅ Dev background (.NET, Azure)
- ✅ CI/CD exposure
