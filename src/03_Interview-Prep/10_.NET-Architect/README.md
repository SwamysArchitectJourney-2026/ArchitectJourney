...
**Comprehensive preparation materials** for .NET Architect interviews with focus on Azure AI, Kubernetes, and enterprise-scale architecture.
...
- [01_Interview-Overview.md](./01_Interview-Overview.md) - Scope and focus areas

### 2. Study Roadmap
- [02_Study-Roadmap.md](./02_Study-Roadmap.md) - Prioritized learning path
...
**New to .NET Architect interviews?**
...
→ Review [Architecture Patterns](./03_Architecture-Patterns-Part1-A.md)

**Practicing interview questions?**
→ Study [Interview Questions](./04_Interview-Questions-Part1-A.md)

---

## 🔗 Related Content

- [AI Architect Interview Prep](../07_AI-Architect/) - AI/ML focused architect preparation
- [Software Architect Prep](../05_Software-Architect/) - General software architecture
