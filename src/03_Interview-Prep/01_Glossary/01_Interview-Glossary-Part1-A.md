...
> 💡 **Database Selection**: For a decision framework on choosing between RDBMS, Document DB, and Columnar DB, see [Database Selection Decision Framework](../../01_Reference/03_Data-and-Storage/01_Database-Selection-Decision-Framework-Part1-A-A.md).
